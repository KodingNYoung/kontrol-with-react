...
const ProjectModal = ({
  ...
  const setModalInput = (actionProject) => {
    const {
      project: { title, stacks, description, githubRepoLink, liveWebsiteLink },
      url,
    } = actionProject;
  ...
  const addEditModal = (
    <form
      className="add-edit-project-form"
      autoComplete="off"
    ...
    >
      <div className="image-input-area">
        ...
        <input
          ...
          accept="image/*"
          id="image"
          className="value-input image-input"
          onChange={handleFileChange}
          ref={imageRef}
          required={modalAction === "add" ? true : false}
        />
      </div>
      <header>
  ...
  const deleteModal = (
    <div className="delete-project-modal">
      ...
      <div className="delete-modal-body">
        ...
        <span className="project-name">{projectTitle}</span> from your list of
        projects?
      </div>
      <footer>
        <button
  ...
  return (
    <div className={modalClass}>
      ...
      <div className="modal-content">
        {modalAction === "delete" ? deleteModal : addEditModal}
        {uploading && (
          <UploadProgress
            image={image}
            project={project}
